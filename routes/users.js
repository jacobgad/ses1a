...
const { isLoggedIn, isUser, usernameToLowerCase } = require('../middleware/users');
...
router.route('/users/:username').put(isLoggedIn, isUser, users.updateUser).delete(isLoggedIn, isUser, users.deleteUser);
